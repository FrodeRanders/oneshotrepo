...
(
    ...
    CONSTRAINT repo_attribute_ver_pk
        PRIMARY KEY (tenantid, unitid, attrid),
    CONSTRAINT repo_attribute_version_attr_ex
        FOREIGN KEY (attrid) REFERENCES repo_attribute (attrid),
    CONSTRAINT repo_attribute_version_ver_e1
        FOREIGN KEY (tenantid, unitid) REFERENCES repo_unit (tenantid, unitid)
)
;
...
(
    ...
    CONSTRAINT repo_log_unit_exists
        FOREIGN KEY (tenantid, unitid) REFERENCES repo_unit (tenantid, unitid)
)
;
...
(
    ...
    CONSTRAINT repo_ia_right_unit_exists
        FOREIGN KEY (assoctenantid, assocunitid) REFERENCES repo_unit (tenantid, unitid)
)
;
